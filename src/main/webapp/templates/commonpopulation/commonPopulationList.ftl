...
<section class="Hui-article-box">
	...
	<div class="Hui-article" style="overflow:hidden;">
		<div class="pos-a" style="width:292px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; background-color:#f5f5f5;overflow:scroll">
	        ...
	        <iframe id="ifr" style="width:100%;height:100%;" src="${base}/commonpopulation/show2?areaCode=-1"></iframe>
...
var setting = {  
        ...
        callback : {  
            ...
            onAsyncSuccess : ztreeOnAsyncSuccess, 
       		onClick:ok, 
       		onCollapse: ztreeOnAsyncSuccess ,//点击减号折叠时触发的事件
       		onExpand: ztreeOnAsyncSuccess,//点击加号展开时出发的事件
...
function ztreeOnAsyncSuccess(event, treeId, treeNode){  
   ...
   if(treeNode == undefined){  
    ...
    if(nodeLength > 0){
    	if(event.type == "click"){
	    	$("#ifr")[0].src=contextPath+"/commonpopulation/show2.do?areaCode="+treeNode.id; 
    	}
    	return;
    }
