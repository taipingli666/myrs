...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统报表 <span class="c-gray en">&gt;</span> 转诊统计<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="Hui-article" style="overflow:hidden;">
        ...
        <iframe id="ifr" style="width:100%;height:100%;" src="${base}/commonpopulation/dualreferralyearreportlist?parentCode=${parentCode!}"></iframe>
...
<script type="text/javascript">
    ...
    function ztreeOnAsyncSuccess(event, treeId, treeNode){
        ...
        if(nodeLength > 0){
        	if(event.type == 'click'){
	            $("#ifr")[0].src=contextPath+"/commonpopulation/dualreferralyearreportlist.do?parentCode="+treeNode.id;
        	}
            return;
        }
