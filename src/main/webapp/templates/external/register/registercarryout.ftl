...
<section class="Hui-article-box">
    ...
    <div class="Hui-article">
        <div class="pd-20">
            <div class="navBox">
                <label for="">
                    <img src="${base }/static/lib/h-ui.admin/images/basic-news/register/list_3.png" alt="">
                </label>
            </div>
            <div class="success">
                ...
                <div class="btnNav" style="font-size:0">
                    <button onclick="javascript:history.back(-2);" id="conApp" value="">继续预约</button>
